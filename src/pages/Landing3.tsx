...
const Landing3 = () => {
  ...
  const heroContent = {
    ...
    headline: "Close deals the moment intent shows up",
    subtitle:
      "Turn your website into a live sales experience. Connect high-intent visitors with real-time voice when they are ready to buy, not after they leave.",
    tagline: "Increase conversion. Increase deal size. Capture revenue you are already paying for.",
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      <SEO
        ...
        description="Voiceable helps revenue teams connect high-intent website visitors with real-time voice conversations, increasing conversion, deal size, and speed to close."
        keywords="live sales, voice AI sales, website conversion, high-intent visitors, pricing page conversion, real-time sales, AI sales assistant, conversion optimization, revenue automation"
        url={currentUrl}
        image="/og-image.png"
      />
      <Header />
