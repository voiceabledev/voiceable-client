    ...
    <div className="h-screen flex relative overflow-hidden">
      ...
      {showCreatePanel && (
        <>
          ...
          <div 
            className={cn(
              "fixed left-0 top-0 bottom-0 w-[600px] bg-card border-r border-border z-50 shadow-xl flex flex-col",
      ...
      <div className="w-80 border-r border-border flex flex-col">
        <div className="p-4 border-b border-border">
          <div className="flex items-center gap-2 mb-4">
            ...
            <a href="#" className="text-muted-foreground hover:text-foreground ml-auto">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="border-b border-border p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-2xl font-bold">{selectedAssistant.name}</h1>
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground mt-1">
                <span>{selectedAssistant.id.slice(0, 20)}...</span>
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  >
                    <div className="text-left">
                      ...
                      <p className="text-sm text-muted-foreground">Select a voice from the list, or sync your voice library if it's missing. If errors persist, enable custom voice and add a voice ID.</p>
                    </div>
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  >
                    <div className="text-left">
                      ...
                      <p className="text-sm text-muted-foreground">Configure additional settings for the voice of your assistant.</p>
                    </div>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  >
                    <div className="text-left">
                      <h3 className="text-lg font-semibold">Transcriber</h3>
                      <p className="text-sm text-muted-foreground">This section allows you to configure the transcription settings for the assistant.</p>
                    </div>
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  >
                    <div className="text-left">
                      ...
                      <p className="text-sm text-muted-foreground">This section allows you to configure the privacy settings for the assistant.</p>
                    </div>
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                ...
                >
                  <div className="text-left">
                    ...
                    <p className="text-sm text-muted-foreground">Configure the behavior of the assistant.</p>
                  </div>
