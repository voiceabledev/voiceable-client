...
const getModelQuality = (provider: string, model: string, pricingSettings: PricingSetting[], commissionMarkup: number): { level: number; label: string; cost: string; modelName: string } => {
