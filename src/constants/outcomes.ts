...
export interface PrimaryOutcome {
  ...
  comingSoon?: boolean; // If true, the outcome is disabled and shows "Coming Soon" label
}

export const PRIMARY_OUTCOMES: PrimaryOutcome[] = [
  // Sales outcomes
  // { value: 'lead_converted', label: 'Lead Converted', type: 'sales', icon: TrendingUp, comingSoon: true },
  ...
  // { value: 'issue_resolved', label: 'Issue Resolved', type: 'support', icon: Wrench, comingSoon: true },
];
